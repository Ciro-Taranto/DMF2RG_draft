...
filename = "rawdata_function_lam.dat"
...
title = r"Channel maximum, $t'=$"+str(tpri) +" van Hove filling + 7 \%" 
...
plt.ylim([0,100.]) 
plt.title(title)
plt.savefig(str(tpri)+filename+".eps")
plt.savefig(str(tpri)+filename+".pdf")
plt.savefig(str(tpri)+filename+".png")
plt.clf()
